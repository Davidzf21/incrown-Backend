...
from .views import anadirParticipante, participantes, eliminarParticipante, esParticipante
...
urlpatterns = [
    ...
    # PARTICIPANTES
    path('participantes/<str:evento>/', participantes.as_view(), name='participantes'),
